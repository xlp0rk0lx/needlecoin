...
const string strMessageMagic = "NeedleCoin Signed Message:\n";
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("NeedleCoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in NeedleCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig, int height) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // NeedleCoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "NeedleCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "needlecoin genesis block";
        CTransaction txNew;
        txNew.nTime = 1500000000;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nNonce   = 385803; // !fTestNet ? 1575379 : 46534;
...
unsigned char pchMessageStart[4] = { 0xbc, 0xfc, 0xe2, 0xe5 };
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv)
{
    ...
    if (strCommand == "version")
    {
        ...
        if (pfrom->nVersion == 10300)
            pfrom->nVersion = 300;
        // TODO -> Single check for these 3 case ?
	if (!vRecv.empty())

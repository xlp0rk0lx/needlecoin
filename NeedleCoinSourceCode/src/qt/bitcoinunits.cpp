...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("NeedleCoins"));
    case mBTC: return QString(QObject::tr("Milli-NeedleCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-NeedleCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}

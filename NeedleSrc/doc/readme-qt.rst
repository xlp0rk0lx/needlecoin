...
Alternatively, install Qt Creator and open the `NeedleCoin-qt.pro` file.

An executable named `NeedleCoin-qt` will be built.
...
installed causes NeedleCoin-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
